...
ActiveRecord::Schema.define(version: 2020_11_25_130416) do
  ...
  create_table "rental_requests", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["instrument_id"], name: "index_rental_requests_on_instrument_id"
  ...
  add_foreign_key "rental_requests", "instruments"
